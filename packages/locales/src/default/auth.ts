export default {
  ...
  'leaderboard.columns.model': 'Model',
  'leaderboard.columns.organization': 'Provider',
  'leaderboard.columns.rank': '#',
  'leaderboard.columns.score': 'Score',
  'leaderboard.count': 'Through rank {{rank}} ({{count}} models)',
  'leaderboard.empty': 'No leaderboard data available',
  'leaderboard.loading': 'Loading...',
  'leaderboard.provider.anthropic': 'Anthropic (U.S. military supplier)',
  'leaderboard.provider.google': 'Google',
  'leaderboard.provider.meta': 'Meta (Facebook / Zuckerberg)',
  'leaderboard.provider.muskFamily': 'SpaceXAI / xAI (Musk)',
  'leaderboard.provider.openai': 'OpenAI (Microsoft)',
  'leaderboard.provider.zhipu': 'Z.ai / Zhipu',
  'leaderboard.source': 'LMSYS Chatbot Arena · lmarena.ai',
  'leaderboard.status.cached': '⚠ Cached data',
  'leaderboard.status.live': '✅ Live data',
  'leaderboard.tag.cn': 'CN',
  'leaderboard.title': 'Global LLM Leaderboard',
